...
function Bulbasaur()
{
	...
	var elemento = document.getElementById("refPokemon");
...
function Pikachu()
{
	var pokemon = new Pokemon( "Pikachu", 100, 65 );
	var elemento = document.getElementById("refPokemon");

	nombrePokemon.innerText = pokemon.nombre;
	datosPokemon.innerText = "Es un Pokémon de tipo eléctrico tiene una vida de " + pokemon.vida + " y un ataque de " + pokemon.ataque + 
...
//	elemento.innerHTML = "Pikachu";
	elemento.href = "http://es.pokemon.wikia.com/wiki/Pikachu";

	document.getElementById( 'imgPokemon').src = "img/pokemon/Pikachu.jpg";
}
